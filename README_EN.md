...
| **macOS Source Tester Alpha** | Source-based testing on Apple Silicon / macOS 15+; no prebuilt app or public macOS Release | **[Open the macOS test hub](publication/MACOS_ALPHA_HUB_EN.md)** · [Download the source tester ZIP](https://github.com/Ponkichi0718/ChromaMatter/releases/download/v0.8beta-macos-source-alpha1/ChromaMatter-0.8beta-macos-source-alpha1.zip) · [Release/checksum](https://github.com/Ponkichi0718/ChromaMatter/releases/tag/v0.8beta-macos-source-alpha1) · [Setup guide](publication/MACOS_ALPHA_TESTING_EN.md) |
...
15+.** Download the exact tagged source ZIP from the
[macOS test hub](publication/MACOS_ALPHA_HUB_EN.md), then Control-click
...
tester's Mac. There is still no approved prebuilt `.app` ZIP: distribution
remains blocked because 253 packaged Mach-O files have unresolved
